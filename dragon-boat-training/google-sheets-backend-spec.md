...
产品规则和待定事项以 [项目说明](README.md) 为准；页面行为见 [前端规格](frontend-spec.md)。P0／P1 核心、P2 报名与维护、P2.1 及 P3 排座与最终更正已经实现，P3 后端部署到 Version 11／服务 `0.6.1-p3`，真实 Google API、Pages 核心浏览器流程和安全清理／退出通过。桌面拖拽及精确 24 小时边界仍保留明确验证限制。本文同时保留 P1 剩余能力和 P4 归档／历史的目标规格，当前证据以[当前进度](CURRENT-STATUS.md)为准。
